...
public abstract class BaseScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String TAG = makeLogTag(BaseScheduleActivity.class);
    ...
    private BaseScheduleHelper mDataHelper;
    ...
    public BaseScheduleActivity() {
        mDataHelper = makeScheduleHelper();
    }

    abstract BaseScheduleHelper makeScheduleHelper();
    ...
    static final class UpdateUIRunnable implements Runnable {
        ...
        final WeakReference<BaseScheduleActivity> weakRefToParent;
        final Handler handler;
        final int today;

        public UpdateUIRunnable(BaseScheduleActivity activity, int today, Handler handler) {
            weakRefToParent = new WeakReference<BaseScheduleActivity>(activity);
        ...
        @Override
        public void run() {
            BaseScheduleActivity activity = weakRefToParent.get();
